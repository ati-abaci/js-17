...
function cards() {
  data.forEach((element) => {
    ...
    //____________________top part of the card_________________________
    ...
    //_________________________middle part of the card__________________
    ...
    //_______________________bottom part of the card_______________________
    ...
    accountName.textContent = element.account;
    ...
    cartDiv.addEventListener("click", () => {
      cardSelected.textContent = `You selected card #${element.id}`;
    });

    // _______________append everything to the html________________________
